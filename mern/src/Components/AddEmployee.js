...
import styles from './modules/AddEmployee.module.css'; // Import CSS module
import axios from 'axios'
import { useNavigate } from 'react-router-dom';

function AddEmployee({ formData, setFormData }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            setErrors({})
            axios.post("http://localhost:5000/addEmployees", {
                name: formData.name,
